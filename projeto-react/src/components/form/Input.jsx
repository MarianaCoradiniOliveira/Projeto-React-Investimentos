...
function Input({type, text, name, placeholder, handleOnChance, value}){ // Define a função do componente Input que recebe várias propriedades como argumentos. Essas propriedades são utilizadas para configurar o comportamento e a aparência do componente.
    ...
    // handleOnChance: Função de callback a ser chamada quando o valor do input é alterado.
    return(
